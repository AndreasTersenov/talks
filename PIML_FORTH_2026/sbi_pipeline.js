...
(function (global) {
  ...
  Engine.COPY={
    ...
    2:"Add <span class='c-warm'>shape noise</span> and a <span class='c-warm'>wavelet transform</span> \\(\\rightarrow\\) <b>summary statistics on each scale separately</b> \\(-\\) so a scale can be dropped later.",
