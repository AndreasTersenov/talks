...
**4 · the chain, and the two questions**
...
**9 · four ways, drawn** ← grey physics, blue network, dashed = trained together
...
**10 · plug-and-play** ← room cue: Lanusse's keynote
...
**13 · conformal calibration** ← three clicks: scores, widened intervals, the guarantee
...
**14 · accurate, smallest calibrated bars**
...
**16 · the nulling** ← one click: the local channels and the matrix
...
**17 · one denoiser, six channels** ← two clicks: the joint loop, the equation
...
**18 · the tomographic result** ← three clicks: the re-mixing, after, the maps
...
**21 · the two hand-crafted features** ← room cue: the wavelet talk before
...
**22 · likelihood-free inference** ← room cue: hand off to Zeghal at 14:00
...
**27 · three open questions, on the chain** ← three clicks
