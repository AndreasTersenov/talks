...
## frame 3 — what ΛCDM is, and where it stops
...
## frame 4 — the probes, and the one we follow
...
## frame 5 — strong and weak lensing
...
## frame 6 — Euclid, and what the signal is
...
## frame 7 — the chain, and the two halves
...
## frame 10 — what the convergence is
...
## frame 11 — shear and convergence from the same potential
...
## frame 12 — the relation is exact, the measurement is not
...
## frame 14 — a data term plus a regulariser
...
## frame 20 — where the gain comes from
...
## frame 22 — what we want from a method
...
## frame 24 — accurate, with calibrated uncertainties
...
## frame 26 — the map has to be compressed
...
## frame 27 — the two-point function
...
## frame 32 — from the summary to the parameters
...
## frame 36 — simulation-based inference
...
## frame 37 — the divider, Part 3

`A3.16b   0:17   ≈ 30:37 in`
...
## frame 38 — why build a statistic by hand
...
## frame 46 — the collision of scales
...
## frame 48 — how large the bias is
...
## frame 50 — is there anything left
